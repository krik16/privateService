...
<div class="coupon-min-width">
		<div class="coupon">
			<div class="coupon-title">财务管理>返佣详情</div>
					...
					<div class="coupon-new">
						...
						<div class="w_100">
							...
							<ul>
								...
								<c:when test="${apply.status==6 }">审核通过</c:when>
								<c:when test="${apply.status==5 }">审核通过</c:when>
										<c:when test="${apply.status==4 }">审核通过</c:when>
										<c:when test="${apply.status==3 }">审核通过</c:when>
										<c:when test="${apply.status==2 }">未审核</c:when>
										<c:when test="${apply.status==-2 }">审核未通过</c:when>
