...
public class SalesCommissionServiceImpl extends BaseServiceImpl implements SalesCommissionService {
    ...
    * @return 
    * @see com.rongyi.tms.service.SalesCommissionService#insert(com.rongyi.easy.tms.entity.SalesCommission) 
    */
    @Override
    ...
    * @param orderNo
    * @return 
    * @see com.rongyi.tms.service.SalesCommissionService#selectByOrderNo(java.lang.String) 
    */
    @Override
    ...
    * @param salesCommission
    * @return 
    * @see com.rongyi.tms.service.SalesCommissionService#updateAll(com.rongyi.easy.tms.entity.SalesCommission) 
    */
    ...
    * @param messageEvent
    * @return 
    * @see com.rongyi.tms.service.SalesCommissionService#addDrawApplyByMQ(com.rongyi.tms.mq.MessageEvent) 
    */
    @Override
    ...
    * @param userId
    * @return 
    * @see com.rongyi.tms.service.SalesCommissionService#selectCommissionInfo(java.lang.String) 
    */
    @Override
