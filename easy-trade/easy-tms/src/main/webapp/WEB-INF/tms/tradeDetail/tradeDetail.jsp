            ...
            <div class="memSuper-search" style="height:130px;width: 100%;">
                ...
                <ur>
                    ...
                    <li><span id="search-time" style="width: 76px;">交易时间段:</span>
                        <input name="start" type="text" value="" class="min bg2 startTime" id="tradeStartTime"
                               style="width:160px"/><span style="margin: 0 -55px 0 -15px">至</span>
                        <input name="end" type="text" value="" class="min bg2 endTime" id="tradeEndTime"
                               style="width:160px"/>
                    </li>

                    <li>
                        <span id="search-price">提现金额：</span>
                        <input type="text" id="minTotalPrice" style="width: 80px"></input><span
                            style="margin: 0 -55px 0 -15px">至</span>
