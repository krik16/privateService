					...
					<tr>
						...
						<c:choose>
							<c:when test="${entity.orderType eq 0}">
								<td><a href="${ctx}/orderManager/orderInfo?orderId=${entity.orderId}&userId=${entity.orderUserId}&module=order&type=tradeDetail" target="_parent"  style="text-decoration:underline" >${entity.orderNo}</a></td>
							</c:when>
							<c:otherwise>
