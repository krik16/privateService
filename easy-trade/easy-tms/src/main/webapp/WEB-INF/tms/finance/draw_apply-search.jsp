...
<script src="${ctx}/js/finance/draw_apply-edit.js" type="text/javascript"></script>
<style type="text/css">
...
<body>
	<div class="memSuper">
		<div class="memSuper-title">财务管理 >提现审核</div>
		<div class="memSuper-main">
			<div style="font-size: 16px;">
				<a class="change-color" id="uncheck" href="javascript:void(0);"
					onclick="switchCheck(1)">待审核</a>| <a class="now"
					href="javascript:void(0);" id="checked" onclick="switchCheck('-2,2')">已审核</a>
			</div>
			...
			<div class="memSuper-search">
				...
				<li id="checkLi" style="display:none;">审核：
					<select id="hadChecked"  style="width: 90px">
						<option value="0">--全部--</option>

						<option value="2,3">已通过</option>
				...
				<li>提现时间段:
						...
						<input name="end" type="text" value="" class="min bg2 endTime" id="payEndTime"  style="margin-right: 20px;"/> 
				 </li>
				...
				<li >
					<sec:authorize ifAnyGranted="TMS_F_BS_VERIFY" >
						<a href="javascript:void(0);" class="btnsearch"style="border:0px;float: right;width: 100px" id="batch-check" onclick="batchCheck();">批量审核通过</a>
					</sec:authorize>
				</li></ur>
			</div>
			</div>
