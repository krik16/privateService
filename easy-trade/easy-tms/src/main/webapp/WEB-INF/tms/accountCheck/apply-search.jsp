...
<script src="${ctx}/js/accountCheck/draw_apply-edit.js" type="text/javascript"></script> 
<style type="text/css">
body {
	background: #fff;
}
...
.memSuper-search input{
	float: none;
}
.memSuper-search select{
...
<body>
	<div class="memSuper">
		<div class="memSuper-title">对账管理>提现明细</div>
		<div class="memSuper-main">
		 <div class="search" style="height: 60px;">
			<div class="memSuper-search" style="height: 130px; width: 100%">
				...
				<li>交易流水号:<input type="text" id="trade-no" class="detail" ></input>
				</li>
				...
				<li> 提现金额：
					<input type="text" id="jine-start" style="width: 120px"/>
						<span style="margin: 0 -55px 0 -15px">至</span>
					<input type="text" id="jine-end" style="width: 120px"/>
				</li> 
				<li><a href="javascript:void(0);" class="btnsearch" id="search" >查询</a> 
				</li>
				<li>
					<sec:authorize ifAnyGranted="TMS_DRAW_EXPORT" ><a class="btnsearch" style="border:0px;float: right;width: 100px" onclick="outExcel()" >导出提现明细</a>
					</sec:authorize>
				</li>
				</ur>
			</div>
			...
			<div id="resultList" class="memSuper-list member-search-list">
				 <input id="currpage" type="hidden" name="currpage" value="<c:out value='${currpage}'/>" />
			</div>
		</div>
	...
	<div class="MsgBoxTip">
		...
		<div class="MsgBoxMain">
			...
			<a style="margin: 0 auto; display: block; float: none;"
				href="javascript:void(0);" class="Button checked"
