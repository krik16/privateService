...
<script src="${ctx}/js/merchant/sales_commission-edit.js" type="text/javascript"></script>
		...
		<div class="memSuper-main">
			...
			<div class="memSuper-search" style="height: 130px; width: 100%">
				...
				<select id="hadChecked" style="width: 100px">
						...
						<option value="2,3,4,5,6">已通过</option>
				...
				<li>小票上传时间段:<input name="start" type="text" value="" class="min bg2 startTime" id="payStartTime"/><span style="margin: 0 -55px 0 -15px">至</span> 
				...
				<li >
					<sec:authorize ifAnyGranted="TMS_SC_VERIFY" ><a href="javascript:batchCheck();" class="btnsearch" style="border:0px;float: right;width: 100px" id="batch-check" onlick="batchCheck();">批量审核通过</a></sec:authorize>
				</li></ur>
			</div>
			</div>
		</div>
