...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	private static String key = ConstantUtil.PayWeiXin.PARTNER_KEY;

	//微信分配的公众号ID（开通公众号之后可以获取到）
	private static String appID =ConstantUtil.PayWeiXin.APP_ID;

	//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private static String mchID =ConstantUtil.PayWeiXin.PARTNER;
	...
	private static String certPassword =ConstantUtil.PayWeiXin.PARTNER;
