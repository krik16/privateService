...
//	private static String key = ConstantUtil.PayWeiXin_V3.KEY;
	private static String key = "b24aaabb1ea8a155c4572570cd260313";

	//微信分配的公众号ID（开通公众号之后可以获取到）
	private static String appID =ConstantUtil.PayWeiXin_V3.APP_ID;

	//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private static String mchID =ConstantUtil.PayWeiXin_V3.MCH_ID;
