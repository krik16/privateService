...
<frameset rows="100,*" cols="*" frameborder="no" border="0" framespacing="0">
  <frame src="${ctx}/main/top?currentMallId=${currentMallId}" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" title="topFrame" />
  <frameset cols="212px,*" frameborder="no" border="0" framespacing="0">
    ...
    <frame src="${ctx}/orderManager/search?module=order" name="mainFrame" id="mainFrame" title="mainFrame" style="border: 1px solid #d9dadc;border-left: 0px;" />
  </frameset>
</frameset>
<noframes><body>
</body>
