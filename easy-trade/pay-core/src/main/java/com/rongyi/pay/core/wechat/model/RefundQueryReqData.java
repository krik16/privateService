 ...
 * 2016/10/11 14:49
 **/
public class RefundQueryReqData extends BaseData {
    //每个字段具体的意思请查看API文档
    ...
    public RefundQueryReqData(String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,String refundID,WechatConfigure wechatConfigure){
