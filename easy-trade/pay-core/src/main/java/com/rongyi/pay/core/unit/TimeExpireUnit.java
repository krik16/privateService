...
import com.rongyi.pay.core.util.DateUtil;
...
public class TimeExpireUnit {
    ...
    public static String aliPayTimeExpire(String timeStart, String timeExpire, int orderType) {
        //默认支付失效时间分钟
...
//        }
     ...
     * Author: 柯军
     **/
    public static Map<String,String> weChatPayTimeExpire(String timeStart, String timeExpire, int orderType) {
