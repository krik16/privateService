 ...
 * 2016/10/11 14:49
 **/
public class PunchCardPayQueryReqData  extends BaseData {
     ...
     * @throws Exception
     */
    public PunchCardPayQueryReqData(String transactionID, String outTradeNo, WechatConfigure wechatConfigure){
        //--------------------------------------------------------------------
