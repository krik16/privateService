 ...
 * 2016/10/11 14:49
 **/
public class RefundReqData extends BaseData {
     ...
     */
    public RefundReqData(String transactionID,String outTradeNo,String deviceInfo,String outRefundNo,Integer totalFee,Integer refundFee,String refundFeeType,WechatConfigure wechatConfigure){
        ...
        setOp_user_id(wechatConfigure.getMchID());
