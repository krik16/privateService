 ...
 * 2016/10/11 14:49
 **/
public class DownloadBillReqData extends BaseData {
    //每个字段具体的意思请查看API文档
    ...
    REVOKED，已撤销的订单
     */
    public DownloadBillReqData(String deviceInfo,String billDate,String billType,WechatConfigure wechatConfigure){
