...
public enum ConstantEnum {
	...
	EXCEPTION_WEIXIN_ORDER_CLOSE("1019331","微信订单关闭失败"),
	...
	EXCEPTION_WEIXIN_REVERSE_SUCCESS("1019330","用户超时未支付,订单已关闭,请重新发起订单支付"),
	...
	EXCEPTION_WEBANK_REVERSE_SUCCESS("1019330","用户超时未支付,订单已关闭,请重新发起订单支付"),
	EXCEPTION_WEBANK_PUNCHCARDREVERSE_FAIL("1019331", "刷卡支付撤销订单失败"),
	EXCEPTION_WEBANK_PUNCHCARDREFUND_FAIL("1019306", "退款失败"),
	EXCEPTION_WEBANK_PUNCHCARDREFUNDQUERY_FAIL("1019307", "退款查询失败"),
	...
	WA_REVERSE_SUCCESS("10000","SUCCESS"), //撤销成功
	...
	WW_PUNCHCARDPAY_REVERSE("REVERSE","已撤销"),
