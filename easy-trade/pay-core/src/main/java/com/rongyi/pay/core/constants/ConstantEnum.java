...
public enum ConstantEnum {
	...
	EXCEPTION_WEBANK_RES_FAIL("1019301","请求微众接口失败"),
	EXCEPTION_WEBANK_PUNCHCARD_FAIL("1019302", "微众刷卡支付失败"),
	EXCEPTION_WEBANK_PUNCHCARDQUERY_FAIL("1019303", "微众刷卡支付订单查询失败"),
	EXCEPTION_WEBANK_REVERSE_SUCCESS("1019304","用户超时未支付,订单已关闭,请重新发起订单支付"),
	EXCEPTION_WEBANK_PUNCHCARDREVERSE_FAIL("1019305", "微众刷卡支付撤销订单失败"),
	EXCEPTION_WEBANK_PUNCHCARDREFUND_FAIL("1019306", "微众刷卡支付退款失败"),
	EXCEPTION_WEBANK_PUNCHCARDREFUNDQUERY_FAIL("1019307", "微众刷卡支付退款失败"),
	...
	WA_PUNCHCARDPAY_SUCCESS("10000","支付成功"),
