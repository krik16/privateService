 ...
 * 2016/10/11 14:49
 **/
public class PunchCardPayReqData extends BaseData {
     ...
     */
    public PunchCardPayReqData(String authCode, String body, String attach, String outTradeNo, int totalFee, String deviceInfo, String spBillCreateIP, String timeStart, String timeExpire, String goodsTag, WechatConfigure wechatConfigure) {
        ...
        //设置服务商模式下的子商户号的ID
        if (StringUtils.isNotBlank(wechatConfigure.getSubMchID())) {
            setSub_mch_id(wechatConfigure.getSubMchID());
        }
        //设置服务商模式下的子公众号的ID
        if (StringUtils.isNotBlank(wechatConfigure.getSubAppID())) {
