...
public class ValidCommissionVO implements Serializable {
	...
	public static class ValidDate implements Serializable {
		...
		public String toString() {
			return "ValidDate [date=" + date + ", list=" + list + "]";
		}
		...
		public static class ValidCoupon implements Serializable {
			...
			@Override
			public String toString() {
				return "ValidCoupon [title=" + title + ", couponCode="
						+ couponCode + ", phone=" + phone + ", time=" + time
	...
	@Override
	public String toString() {
		return "ValidCommissionVO [totalPage=" + totalPage + ", pageSize="
				+ pageSize + ", currpage=" + currpage + ", number=" + number
				+ ", totalAmount=" + totalAmount + ", myValidList="
				+ myValidList + "]";
	}
