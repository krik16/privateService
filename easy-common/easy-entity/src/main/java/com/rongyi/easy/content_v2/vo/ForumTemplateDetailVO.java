...
/**
 * Created by lijing on 2015/12/23 17:47
 * .com.rongyi.easy.content_v2.vo
 * easy-api
 */
public class ForumTemplateDetailVO implements Serializable{
    /**id*/
    private Integer id;
    /**首页id*/
    ...
    public String getCreateAt() {
        return DateTool.date2String(this.createAt, DateTool.FORMAT_DATETIME);
    }
