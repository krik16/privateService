...
public class CouponEntity implements Serializable {
    ...
    public ObjectId getHolder_id() {
        return holder_id;
    }

    public void setHolder_id(ObjectId holder_id) {
    ...
    public List<ObjectId> getShop_ids() {
        return shop_ids;
    }

    public void setShop_ids(List<ObjectId> shop_ids) {
    ...
    public Integer getVisted_num() {
        return visted_num;
    }

    public void setVisted_num(Integer visted_num) {
