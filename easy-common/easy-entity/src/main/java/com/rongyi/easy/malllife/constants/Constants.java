...
public interface Constants {
    ...
    interface SOME_TIME {
        ...
        int MALLLIFE_USERLOGIN_FORGETPWD_KEY=60*5;//MALLLIFE 找回密码
        int MALLLIFE_USERLOGIN_BINDPHONE_KEY=60*5;//MALLLIFE 绑定手机号
        int MALLLIFE_USERLOGIN_WECHAT_KEY=60*5;//MALLLIFE 微信绑定手机号
        int MALLLIFE_QRCODE_KEY=60*5;//MALLLIFE 登录码
     ...
     */
    String[] OPEN_CITYS = {"上海","北京","广州","深圳","重庆","沈阳"};
    /**
     * APP开放的城市id:上海（已开放）、北京、广州、深圳、重庆、沈阳
     */
    String[] OPEN_CITY_IDS = {"51f9d7f231d6559b7d000002","51f9d7f331d6559b7d00003c","51f9d7f331d6559b7d000021","51f9d7f431d6559b7d000087","52099e5531d6557be300001a","51f9d7f531d6559b7d0000c2"};
    /**
     * 默认上海的ID
     */
