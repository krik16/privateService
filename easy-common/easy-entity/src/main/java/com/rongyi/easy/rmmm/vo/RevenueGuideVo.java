...
public class RevenueGuideVo implements Serializable {
	...
	public String toString() {
		return "RevenueGuideVo [amountTotal=" + amountTotal
				+ ", auditCommissionTotal=" + auditCommissionTotal
				+ ", bonusToday=" + bonusToday + ", drawingTotal="
				+ drawingTotal + ", tradeAmountToday=" + tradeAmountToday + "]";
	}
