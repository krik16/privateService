...
public class CommodityVO implements Serializable {
	...
	private Integer terminalType;// 上架终端：1.表示容易逛2.表示互动屏3.表示容易逛和互动屏4.表示微商5.微商,容易逛6.微商,互动屏7.容易逛,
									// 互动屏, 微商(转换成二进制数个位1有容易逛第二位1有 互动屏第三位1有 微商)
	...
	public String toString() {
		return "CommodityVO{" + "commodityId='" + commodityId + '\'' + ", commodityName='" + commodityName + '\''
				+ ", commodityCategory='" + commodityCategory + '\'' + ", commodityDescription='" + commodityDescription + '\''
				+ ", commodityPostage='" + commodityPostage + '\'' + ", commodityStock='" + commodityStock + '\''
				+ ", commoditySold='" + commoditySold + '\'' + ", commodityPubDate='" + commodityPubDate + '\''
				+ ", commodityStatus=" + commodityStatus + ", commodityOPriceMax='" + commodityOPriceMax + '\''
				...
				+ ", commodityType=" + commodityType + ", isSpot=" + isSpot + ", liveStartTime=" + liveStartTime
				+ ", liveEndTime=" + liveEndTime + ", create_by='" + create_by + '\'' + ", liveId='" + liveId + '\''
				+ ", commodityOriginalPrice='" + commodityOriginalPrice + '\'' + ", commodityCurrentPrice='"
				+ commodityCurrentPrice + '\'' + ", shopId='" + shopId + '\'' + ", shopMid='" + shopMid + '\''
				...
				+ ", commodityCommission='" + commodityCommission + '\'' + ", brandMid='" + brandMid + '\'' + ", mallMid='"
				+ mallMid + '\'' + ", shopName='" + shopName + '\'' + ", supportCourierDeliver=" + supportCourierDeliver
	...
	/*
	 * public Integer getDistribution() { return distribution; } public void
	 * setDistribution(Integer distribution) { this.distribution = distribution;
	 * }
	 */
