...
public class IntegralGift implements java.io.Serializable{
    /**
	 * 
	 */
    ...
    public String toString() {
        return "IntegralGift [title=" + title + ", id=" + id + ", mallId=" + mallId + ", code=" + code
                + ", description=" + description + ", totalNum=" + totalNum + ", personalTimes=" + personalTimes
                + ", thumbnail=" + thumbnail + ", shelvesDate=" + shelvesDate + ", offShelvesDate=" + offShelvesDate
                + ", deadline=" + deadline + ", exchangeIntegral=" + exchangeIntegral + ", favourableStartTime="
                + favourableStartTime + ", favourableEndTime=" + favourableEndTime + ", favourableIntegral="
                + favourableIntegral + ", receiveTimes=" + receiveTimes + ", status=" + status + "]";
    }
