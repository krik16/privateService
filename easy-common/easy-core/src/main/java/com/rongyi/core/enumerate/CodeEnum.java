...
public enum CodeEnum {
    ...
    ERROR_MCMC_COMMODITY_CODE_EMPTY("-7009", 		"商品编号错误"),
    ERROR_MCMC_COMMODITY_SHOP_SPEC("-7010", 		"商品关联店铺已存在"),
    ERROR_MCMC_COMMODITY_BRAND_SPEC("-7011", 		"商品关联品牌已存在"),
    /** 百联优惠券常量 */
    ...
    //操作权限错误
    ERROR_MISS_SHOP_EDIT("1101101",					"操作的商品必须同一个店铺"),
	ERROR_MISS_OWNER_EDIT("1101102",				"只能操作自己的商品"),
	ERROR_MISS_PARENT_EDIT("1101103",				"只允许分公司和店长操作此商品");
