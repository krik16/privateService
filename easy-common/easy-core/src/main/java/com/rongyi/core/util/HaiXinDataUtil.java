...
public class HaiXinDataUtil {
	 ...
	 *
	 * @param url    路径
	 * @param type   类型  如: 2026 品牌，2025 类目,psXMLData：传入的XML报文,psOperateTypeCode
	 * @return
	...
	public static <T>List<T> invokeRemoteFuc(String url,Integer psOperateTypeCode, Integer psDataType,String psXMLData) throws ServiceException, RemoteException {
      ...
      //  String xml="<?xml version=\"1.0\" encoding=\"UTF-8\"?><IMPORTDATA><OPERATION>1</OPERATION></IMPORTDATA>";
        // 设置被调用方法的返回值类型
