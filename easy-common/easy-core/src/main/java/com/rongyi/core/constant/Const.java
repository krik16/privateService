...
public interface Const {
	...
	// final String UPAIYUN_URL_MALL_APPEARANCE_PIC =
	// "http://rongyi.b0.upaiyun.com/system/mall/appearance_pic/"; //
	// 云盘路径-商场app外景图
	// final String UPAIYUN_URL_MALL_WEB_APPEARANCE_PIC =
	// "http://rongyi.b0.upaiyun.com/system/mall/web_appearance_pic/"; //
	// 云盘路径-商场web外景图
	// final String UPAIYUN_URL_MALL_TRAFFIC_PIC =
	// "http://rongyi.b0.upaiyun.com/system/mall/traffic_pic/"; // 云盘路径-商场交通图
	// final String UPAIYUN_URL_MALL_WEB_INTRODUCTION_PIC =
	// "http://rongyi.b0.upaiyun.com/system/mall/introduction_pic/"; //
	// 云盘路径-商场介绍图
	// final String UPAIYUN_URL_MALL_WEB_TERMINAL_LOGO =
	// "http://rongyi.b0.upaiyun.com/system/mall/terminal_logo/"; //
	// 云盘路径-终端机logo
	// final String UPAIYUN_URL_MALL_WECHAT_PIC =
	// "http://rongyi.b0.upaiyun.com/system/mall/wechat/"; // 云盘路径-微信展示商场的图片
	// final String
	// UPAIYUN_URL_MALL_ICON="http://rongyi.b0.upaiyun.com/system/mall/icon/";
	...
	/**商家后台logo**/
	final String UPAIYUN_URL_MER_LOGO_PIC = "http://rongyi.b0.upaiyun.com/system/mall/merlog/";
	...
	/** 公共类型 **/
	public final static HashMap<Integer, String> Common_TYPE = new HashMap<Integer, String>() {
