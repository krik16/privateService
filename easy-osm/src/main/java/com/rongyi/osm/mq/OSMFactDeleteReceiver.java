 ...
 * @Description:  OSM主从同步接收fact，从kSession中删除对应fact
 ...
 */
@Component
public class OSMFactDeleteReceiver implements ChannelAwareMessageListener {
	...
	public void onMessage(Message message, Channel channel) {
		...
		try {
			...
			obj = ois.readObject();
			logger.info("Sync Delete received fact: " + obj.getClass().getName());
