...
<html>
	<body>
		<form action="../union/validateCoupon" method="post">
			...
			<input type="hidden" name="msg_txn_code" value="002003" />
			...
			<input type="hidden" name="req_serial_no" value="20130921155443030786" />
			<input type="hidden" name="orig_req_serial_no" value="20130921155443030785" />
			...
			<input type="hidden" name="orig_amt" value="100"/>
			<input type="hidden" name="avl_amt" value="50"/>
			<input type="hidden" name="pay_mode" value="2"/>
			...
			<input type="hidden" name="sp_pwd" value="123456" />
			<input type="hidden" name="sign" value ="" />
			<input type="submit" value="002003" />
		</form>
	</body>
</html>